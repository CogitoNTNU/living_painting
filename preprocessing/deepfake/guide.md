# DeepFaceLab Installation Guide

## Minimum Requirements:
- Windows or Linux operating system
- 16GB of RAM
- plenty of storage space and pagefile set to 4 x of RAM size minimum
- modern 4 core CPU supporting AVX and SEE instructions
- modern Nvidia or AMD GPU with 6GB of VRAM

## Download and install 
- Go to: https://github.com/iperov/DeepFaceLab and scroll down to the releases.
- Download one of the releases.
- DoubleClick on the .exe file or use another zip file program to extract. Now you will have a folder labelled: *DeepFaceLab_NVIDIA*

# DeepFaceLab Deepfake Guide

## Add your own videos
If you already have to files labelled:
- *data_dst.mp4*
- *data_src.mp4*
...
## Extract Images
- DoubleClick on the file labelled: *2) extract images from video data_src.bat*
  - Click on enter a few times to use the default values
- DoubleClick on the file labelled: *3) extract images from video data_dst FULL FPS.bat*  
  - Click on enter a few times to use the default values

## Extract Facesets
- DoubleClick on the file labelled: *4) data_src faceset extract.bat*
  - Use the default settings
  - After a few minutes the extraction will complete and report on the number of images and faces detected 
- DoubleClick on the file labelled: *5) data_sdst faceset extract.bat*
...
## Training
- DoubleClick on the file labelled: *6) train Quick96.bat*
  - Click on enter a few times to use the default values
...
- DoubleClick on the file labelled: *7) merge Quick96.bat*
  - Click on enter a few times to use the default values
...
The command window will show you which image you are watching and details of the deepfake:
...
> Process remain frames

### Start the merging
- Advance to the first frame
- Change the erode mask value to 20
- Change the blur mask value to 100
- Apply these setting to the rest of the frames by pressing shift and the slash keys simultaneously
- Process the remaining frames by pressing the shift and period / greater than keys
- Once the merger reaches 100% we can close both windows

## Finishing
Merge our new deepfake frames into a video file with our destination audio
- DoubleClick on the file labelled: *8) merged to mp4.bat*
